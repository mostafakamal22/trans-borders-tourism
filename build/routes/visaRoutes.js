...
router.route("/").post(authAdminProtect_1.authAdminProtect, visaControllers_1.createVisa);
router.route("/query").post(authAdminProtect_1.authAdminProtect, visaControllers_1.getVisas);
router
    .route("/:id")
