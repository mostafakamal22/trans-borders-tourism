...
router
    .route("/")
    .post(authAdminProtect_1.authAdminProtect, passportControllers_1.createPassport)
    .get(authAdminProtect_1.authAdminProtect, passportControllers_1.getPassports);
router
    .route("/:id")
