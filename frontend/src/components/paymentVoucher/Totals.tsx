...
import { paymentVouchersCalculations } from "./calculations";
...
export const Totals = ({
  ...
  const { totals } = paymentVouchersCalculations(paymentVouchers);

  const tableBody: string[][] = [["سندات الصرف", totals.toFixed(2)]];
