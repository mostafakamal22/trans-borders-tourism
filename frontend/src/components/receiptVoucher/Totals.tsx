...
import { receiptVouchersCalculations } from "./calculations";
...
export const Totals = ({
  ...
  const { totals } = receiptVouchersCalculations(receiptVouchers);

  const tableBody: string[][] = [["سندات القبض", totals.toFixed(2)]];
